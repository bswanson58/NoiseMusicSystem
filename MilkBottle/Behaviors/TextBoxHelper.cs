...
namespace MilkBottle.Behaviors {
	// from: https://github.com/MahApps/MahApps.Metro/blob/master/MahApps.Metro/Controls/TextboxHelper.cs

	// XAML usage:
	/*
		<TextBox Style="{StaticResource WaterMarkTextBox}"
					Behaviours:TextBoxHelper.Watermark="enter text..." Behaviours:TextBoxHelper.ClearTextButton="True"/>
	*/
				...
				<ControlTemplate TargetType="{x:Type TextBox}">
					...
					<Border Name="Bd" 
						...
						<Grid>
							...
							<Button x:Name="PART_ClearText" Foreground="{DynamicResource BorderColor}" Width="16" BorderThickness="0" Background="Transparent"
										HorizontalAlignment="Right" Margin="3" FontFamily="Marlett" Content="r" Visibility="{Binding RelativeSource={RelativeSource TemplatedParent},
	...
	*/
	...
	public class TextBoxHelper : DependencyObject {
		...
		public static readonly DependencyProperty ClearTextButtonProperty =
			DependencyProperty.RegisterAttached( "ClearTextButton", typeof( bool ), typeof( TextBoxHelper ), new FrameworkPropertyMetadata( false, ClearTextChanged ));
