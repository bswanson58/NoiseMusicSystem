...
namespace AirSpace.Interop {
    ...
    /// </remarks>
    /// usage:
    /// <interop:AirspaceDecorator Grid.Row="1" AirspaceMode="Redirect" Background="White" IsInputRedirectionEnabled="True" IsOutputRedirectionEnabled="True">
    ///     <!-- A WindowsFormsHost based view -->
    ///     <WindowsFormsHost/>
    /// </interop:AirspaceDecorator>
    /// <!-- Overlaid XAML content -->
    /// <TextBlock Grid.Row="1" VerticalAlignment="Center" HorizontalAlignment="Center" FontSize="24" Opacity="0.5" Text="Hello!"/>
