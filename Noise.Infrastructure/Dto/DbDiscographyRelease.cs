...
namespace Noise.Infrastructure.Dto {
	...
	public class DbDiscographyItem {
		public string					Title { get; protected set; }
		public string					Format { get; protected set; }
		public string					Label { get; protected set; }
		public int						Year { get; protected set; }
		...
		protected DbDiscographyItem() :
			this( string.Empty, string.Empty, string.Empty, Constants.cUnknownYear, DiscographyReleaseType.Unknown ) { }

		public DbDiscographyItem( string title, string format, string label, int year, DiscographyReleaseType releaseType ) {
			Title = title;
			Format = format;
			Label = label;
			ReleaseType = releaseType;
